...
public class FabricatedOverlay {
    ...
    public OverlayIdentifier getIdentifier() {
        return new OverlayIdentifier(
                mOverlay.packageName,
                TextUtils.isEmpty(mOverlay.overlayName) ? null : mOverlay.overlayName);
    }
    ...
    public static class Builder {
        ...
        public Builder setTargetOverlayable(@Nullable String targetOverlayable) {
          mTargetOverlayable = TextUtils.isEmpty(targetOverlayable) ? null : targetOverlayable;
            return this;
        }
